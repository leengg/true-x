...
- (void)viewDidLoad
{
    ...
    NSString *headStyle = [NSString stringWithFormat:@"<head><style type=\"text/css\">body {font-family:\"Helvetica\"; font-size:14px;color:#FFF;} img {max-width: 300px !important;} img.center { display: block; margin-left: auto; margin-right: auto; } a { color:#FFF;}</style></head>"];
